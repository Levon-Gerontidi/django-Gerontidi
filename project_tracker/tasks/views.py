...
def index(request):
    ...
    html = f"<h1>Страница приложения tasks</h1><p><a href='{another_page_url}'>Перейти на другую страницу</a></p><p><a href='{quality_control_index_url}'>Система контроля качества</a></p>"
...
def index(request):
    ...
    quality_control_index_url = reverse('quality_control:index')
    html = f"<h1>Страница приложения tasks</h1><p><a href='{projects_list_url}'>Список проектов</a></p><p><a href='{quality_control_index_url}'>Система контроля качества</a></p>"
    return HttpResponse(html)
...
class IndexView(View):
    def get(self, request, *args, **kwargs):
        projects_list_url = reverse('tasks:projects_list')
        html = html = f"<h1>Страница приложения tasks</h1><a href='{projects_list_url}'>Список проектов</a>"
        return HttpResponse(html)
